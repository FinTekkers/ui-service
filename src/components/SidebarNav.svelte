...
<div class="mobile-nav">
    <!-- Overlay -->
    {#if menuOpen}
        <div class="fixed inset-0 bg-black/40 z-40" on:click={closeMenu} />
    {/if}

    <!-- Slide-in Menu -->
    <div
        class={`fixed top-0 left-0 h-full w-64 body-cover shadow-lg z-50 transform transition-transform duration-300 ${
...
<style lang="scss">
    @import "../styles/_shared.scss"; // Adjust to your path
