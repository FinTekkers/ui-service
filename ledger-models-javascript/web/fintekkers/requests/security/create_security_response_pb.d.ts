...
import * as fintekkers_requests_security_create_security_request_pb from "./create_security_request_pb";
...
export class CreateSecurityResponseProto extends jspb.Message {
  ...
  getSecurityRequest():
    ...
    | undefined;
  setSecurityRequest(
    value?: fintekkers_requests_security_create_security_request_pb.CreateSecurityRequestProto
  ...
  static toObject(
    ...
    msg: CreateSecurityResponseProto
  ): CreateSecurityResponseProto.AsObject;
