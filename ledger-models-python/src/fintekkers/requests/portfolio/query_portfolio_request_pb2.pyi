...
class QueryPortfolioRequestProto(_message.Message):
    __slots__ = ["object_class", "search_portfolio_input", "uuids", "version"]
    ...
    version: str
    def __init__(self, object_class: _Optional[str] = ..., version: _Optional[str] = ..., uuids: _Optional[_Iterable[_Union[_uuid_pb2.UUIDProto, _Mapping]]] = ..., search_portfolio_input: _Optional[_Union[_position_filter_pb2.PositionFilterProto, _Mapping]] = ...) -> None: ...
