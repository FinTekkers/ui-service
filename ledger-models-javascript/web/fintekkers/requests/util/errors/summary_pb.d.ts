...
import * as fintekkers_requests_util_errors_error_pb from "./error_pb";

export class SummaryProto extends jspb.Message {
  getErrorsList(): Array<fintekkers_requests_util_errors_error_pb.ErrorProto>;
  setErrorsList(
    value: Array<fintekkers_requests_util_errors_error_pb.ErrorProto>
  ): SummaryProto;
  clearErrorsList(): SummaryProto;
  addErrors(
    value?: fintekkers_requests_util_errors_error_pb.ErrorProto,
    index?: number
  ): fintekkers_requests_util_errors_error_pb.ErrorProto;

  getWarningsList(): Array<fintekkers_requests_util_errors_error_pb.WarningProto>;
  setWarningsList(
    value: Array<fintekkers_requests_util_errors_error_pb.WarningProto>
  ): SummaryProto;
  clearWarningsList(): SummaryProto;
  addWarnings(
    value?: fintekkers_requests_util_errors_error_pb.WarningProto,
    index?: number
  ): fintekkers_requests_util_errors_error_pb.WarningProto;
