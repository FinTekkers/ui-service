...
import common.model.security.ProductType;
...
public enum Field {
    ...
    STRATEGY(common.model.strategy.Strategy.class, "The strategy used to derive why a specific transaction " +
    ...
    POSITION_STATUS(PositionStatus.class, "Represents the stage of the lifecycle of a transaction which " +
            ...
            "Note, this field does not model clearing nor settlement status"),

    //Security fields
    SECURITY(common.model.security.Security.class, "A fully fledged security object"),
    ...
    CASH_IMPACT_SECURITY(common.model.security.Security.class, "A fully fledged security object representing" +
    ...
    PORTFOLIO(common.model.portfolio.Portfolio.class, "A fully fledged portfolio object"),
    ...
    //Price
    PRICE(common.model.price.Price.class, "A fully fledged price object"),
