...
import * as fintekkers_models_util_local_date_pb from "../util/local_date_pb";
import * as fintekkers_models_util_local_timestamp_pb from "../util/local_timestamp_pb";
import * as fintekkers_models_util_uuid_pb from "../util/uuid_pb";
import * as fintekkers_models_security_identifier_identifier_pb from "./identifier/identifier_pb";
import * as fintekkers_models_security_security_type_pb from "./security_type_pb";
import * as fintekkers_models_security_security_quantity_type_pb from "./security_quantity_type_pb";
import * as fintekkers_models_security_coupon_frequency_pb from "./coupon_frequency_pb";
import * as fintekkers_models_security_coupon_type_pb from "./coupon_type_pb";
...
export class SecurityProto extends jspb.Message {
  ...
  setSecurityType(
    value: fintekkers_models_security_security_type_pb.SecurityTypeProto
  ): SecurityProto;
  ...
  setQuantityType(
    value: fintekkers_models_security_security_quantity_type_pb.SecurityQuantityTypeProto
  ): SecurityProto;

  getIdentifier():
    | fintekkers_models_security_identifier_identifier_pb.IdentifierProto
    | undefined;
  setIdentifier(
    value?: fintekkers_models_security_identifier_identifier_pb.IdentifierProto
  ): SecurityProto;
  ...
  setCouponType(
    value: fintekkers_models_security_coupon_type_pb.CouponTypeProto
  ): SecurityProto;

  getCouponFrequency(): fintekkers_models_security_coupon_frequency_pb.CouponFrequencyProto;
  setCouponFrequency(
    value: fintekkers_models_security_coupon_frequency_pb.CouponFrequencyProto
  ): SecurityProto;

  getDatedDate():
    | fintekkers_models_util_local_date_pb.LocalDateProto
    | undefined;
  setDatedDate(
    value?: fintekkers_models_util_local_date_pb.LocalDateProto
  ): SecurityProto;
