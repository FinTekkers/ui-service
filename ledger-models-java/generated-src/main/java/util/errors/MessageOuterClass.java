...
// source: requests/util/errors/message.proto
...
public final class MessageOuterClass {
  ...
  public interface MessageOrBuilder extends
      // @@protoc_insertion_point(interface_extends:util.errors.Message)
  ...
  /**
   * Protobuf type {@code util.errors.Message}
   */
  public static final class Message extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:util.errors.Message)
      MessageOrBuilder {
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return util.errors.MessageOuterClass.internal_static_util_errors_Message_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return util.errors.MessageOuterClass.internal_static_util_errors_Message_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              util.errors.MessageOuterClass.Message.class, util.errors.MessageOuterClass.Message.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof util.errors.MessageOuterClass.Message)) {
        return super.equals(obj);
      }
      util.errors.MessageOuterClass.Message other = (util.errors.MessageOuterClass.Message) obj;
    ...
    public static util.errors.MessageOuterClass.Message parseFrom(
    ...
    public static util.errors.MessageOuterClass.Message parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static util.errors.MessageOuterClass.Message parseFrom(
    ...
    public static util.errors.MessageOuterClass.Message parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static util.errors.MessageOuterClass.Message parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static util.errors.MessageOuterClass.Message parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(util.errors.MessageOuterClass.Message prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:util.errors.Message)
        util.errors.MessageOuterClass.MessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return util.errors.MessageOuterClass.internal_static_util_errors_Message_descriptor;
      }
      ...
      // Construct using util.errors.MessageOuterClass.Message.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public util.errors.MessageOuterClass.Message getDefaultInstanceForType() {
        return util.errors.MessageOuterClass.Message.getDefaultInstance();
      }

      @java.lang.Override
      public util.errors.MessageOuterClass.Message build() {
        util.errors.MessageOuterClass.Message result = buildPartial();
      ...
      @java.lang.Override
      public util.errors.MessageOuterClass.Message buildPartial() {
        util.errors.MessageOuterClass.Message result = new util.errors.MessageOuterClass.Message(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof util.errors.MessageOuterClass.Message) {
          return mergeFrom((util.errors.MessageOuterClass.Message)other);
        } else {
      ...
      public Builder mergeFrom(util.errors.MessageOuterClass.Message other) {
        if (other == util.errors.MessageOuterClass.Message.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        util.errors.MessageOuterClass.Message parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (util.errors.MessageOuterClass.Message) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:util.errors.Message)
    }

    // @@protoc_insertion_point(class_scope:util.errors.Message)
    private static final util.errors.MessageOuterClass.Message DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new util.errors.MessageOuterClass.Message();
    }

    public static util.errors.MessageOuterClass.Message getDefaultInstance() {
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_util_errors_Message_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_util_errors_Message_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\"requests/util/errors/message.proto\022\013ut" +
      "il.errors\"B\n\007Message\022\030\n\020message_for_user" +
      "\030\001 \001(\t\022\035\n\025message_for_developer\030\002 \001(\tb\006p" +
      "roto3"
    };
    ...
    internal_static_util_errors_Message_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_util_errors_Message_descriptor,
