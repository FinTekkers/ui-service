...
import * as fintekkers_models_security_identifier_identifier_type_pb from "./identifier_type_pb";
...
export class IdentifierProto extends jspb.Message {
  ...
  setIdentifierType(
    value: fintekkers_models_security_identifier_identifier_type_pb.IdentifierTypeProto
  ): IdentifierProto;
