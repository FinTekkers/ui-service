...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 90: {
            ...
            nodeState_ = input.readMessage(common.util.locks.NodeStateProto.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return common.request.lock.LockRequestProtos.internal_static_util_lock_LockRequestProto_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return common.request.lock.LockRequestProtos.internal_static_util_lock_LockRequestProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            common.request.lock.LockRequestProto.class, common.request.lock.LockRequestProto.Builder.class);
  }
  ...
  private common.util.locks.NodeStateProto nodeState_;
  /**
   ...
   */
  @java.lang.Override
  public common.util.locks.NodeStateProto getNodeState() {
    return nodeState_ == null ? common.util.locks.NodeStateProto.getDefaultInstance() : nodeState_;
  }
  /**
   * <code>.util.lock.NodeStateProto node_state = 11;</code>
   */
  @java.lang.Override
  public common.util.locks.NodeStateProtoOrBuilder getNodeStateOrBuilder() {
    return getNodeState();
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof common.request.lock.LockRequestProto)) {
      return super.equals(obj);
    }
    common.request.lock.LockRequestProto other = (common.request.lock.LockRequestProto) obj;
  ...
  public static common.request.lock.LockRequestProto parseFrom(
  ...
  public static common.request.lock.LockRequestProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static common.request.lock.LockRequestProto parseFrom(
  ...
  public static common.request.lock.LockRequestProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static common.request.lock.LockRequestProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static common.request.lock.LockRequestProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(common.request.lock.LockRequestProto prototype) {
  ...
  public static final class Builder extends
      ...
      common.request.lock.LockRequestProtoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return common.request.lock.LockRequestProtos.internal_static_util_lock_LockRequestProto_descriptor;
    }
    ...
    // Construct using common.request.lock.LockRequestProto.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public common.request.lock.LockRequestProto getDefaultInstanceForType() {
      return common.request.lock.LockRequestProto.getDefaultInstance();
    }

    @java.lang.Override
    public common.request.lock.LockRequestProto build() {
      common.request.lock.LockRequestProto result = buildPartial();
    ...
    @java.lang.Override
    public common.request.lock.LockRequestProto buildPartial() {
      common.request.lock.LockRequestProto result = new common.request.lock.LockRequestProto(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof common.request.lock.LockRequestProto) {
        return mergeFrom((common.request.lock.LockRequestProto)other);
      } else {
    ...
    public Builder mergeFrom(common.request.lock.LockRequestProto other) {
      if (other == common.request.lock.LockRequestProto.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      common.request.lock.LockRequestProto parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (common.request.lock.LockRequestProto) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        common.util.locks.NodeStateProto, common.util.locks.NodeStateProto.Builder, common.util.locks.NodeStateProtoOrBuilder> nodeStateBuilder_;
    /**
     * <code>.util.lock.NodeStateProto node_state = 11;</code>
     * @return Whether the nodeState field is set.
     */
     ...
     * <code>.util.lock.NodeStateProto node_state = 11;</code>
     */
    public Builder setNodeState(common.util.locks.NodeStateProto value) {
      if (nodeStateBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.util.lock.NodeStateProto node_state = 11;</code>
     */
    public Builder mergeNodeState(common.util.locks.NodeStateProto value) {
      if (nodeStateBuilder_ == null) {
        if (nodeState_ != null) {
          nodeState_ =
            common.util.locks.NodeStateProto.newBuilder(nodeState_).mergeFrom(value).buildPartial();
        } else {
          nodeState_ = value;
        }
        onChanged();
     ...
     * <code>.util.lock.NodeStateProto node_state = 11;</code>
     */
    public common.util.locks.NodeStateProto.Builder getNodeStateBuilder() {
    ...
    public common.util.locks.NodeStateProtoOrBuilder getNodeStateOrBuilder() {
      if (nodeStateBuilder_ != null) {
        ...
        return nodeState_ == null ?
            common.util.locks.NodeStateProto.getDefaultInstance() : nodeState_;
      }
    }
    /**
     * <code>.util.lock.NodeStateProto node_state = 11;</code>
  ...
  private static final common.request.lock.LockRequestProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new common.request.lock.LockRequestProto();
  }

  public static common.request.lock.LockRequestProto getDefaultInstance() {
