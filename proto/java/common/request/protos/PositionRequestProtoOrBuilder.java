...
public interface PositionRequestProtoOrBuilder extends
   ...
   */
  java.util.List<common.model.protos.MeasureProto> getMeasuresList();
  /**
   * <code>repeated .position.MeasureProto measures = 31;</code>
   ...
   */
  common.model.protos.MeasureProto getMeasures(int index);
  /**
   * <code>repeated .position.MeasureProto measures = 31;</code>
   ...
   */
  common.model.protos.PositionFilterProto getFilterFields();
  /**
   * <code>.position.PositionFilterProto filter_fields = 32;</code>
   */
  common.model.protos.PositionFilterProtoOrBuilder getFilterFieldsOrBuilder();
