...
@javax.annotation.Generated(
    ...
    comments = "Source: services/lock-service/lock_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class LockGrpc {

  private LockGrpc() {}

  public static final String SERVICE_NAME = "lock_service.Lock";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<common.request.lock.LockRequestProto,
      common.request.lock.LockResponseProto> getClaimLockMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ClaimLock",
      requestType = common.request.lock.LockRequestProto.class,
      responseType = common.request.lock.LockResponseProto.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<common.request.lock.LockRequestProto,
      common.request.lock.LockResponseProto> getClaimLockMethod() {
    io.grpc.MethodDescriptor<common.request.lock.LockRequestProto, common.request.lock.LockResponseProto> getClaimLockMethod;
      ...
      synchronized (LockGrpc.class) {
        if ((getClaimLockMethod = LockGrpc.getClaimLockMethod) == null) {
          LockGrpc.getClaimLockMethod = getClaimLockMethod =
              io.grpc.MethodDescriptor.<common.request.lock.LockRequestProto, common.request.lock.LockResponseProto>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ClaimLock"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  common.request.lock.LockRequestProto.getDefaultInstance()))
  ...
  public static abstract class LockImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void claimLock(common.request.lock.LockRequestProto request,
        io.grpc.stub.StreamObserver<common.request.lock.LockResponseProto> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                common.request.lock.LockRequestProto,
                common.request.lock.LockResponseProto>(
  ...
  public static final class LockBlockingStub extends io.grpc.stub.AbstractBlockingStub<LockBlockingStub> {
    ...
    /**
     */
    public common.request.lock.LockResponseProto claimLock(common.request.lock.LockRequestProto request) {
  ...
  public static final class LockFutureStub extends io.grpc.stub.AbstractFutureStub<LockFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<common.request.lock.LockResponseProto> claimLock(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CLAIM_LOCK:
          serviceImpl.claimLock((common.request.lock.LockRequestProto) request,
              (io.grpc.stub.StreamObserver<common.request.lock.LockResponseProto>) responseObserver);
          break;
        default:
  ...
  private static abstract class LockBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return common.service.LockService.getDescriptor();
    }
