...
<div class="landing-page-container">
    <div class="landing-content">
        ...
        <p class="landing-description">
            We worry about scale, security and plumbing while you focus on your
            competitive advantage, your ideas.
        </p>
        <div class="landing-cta-buttons">
            <a class="button try-now-button" href="/login">Try Now</a>
            <a class="button explore-product-button" href="/data/portfolios"
                >Explore Product</a
            >
            <a class="button try-now-button" href="/data/portfolios"
                >Explore Data</a
            >
        </div>
...
<style lang="scss">
    ...
    .landing-page-container {
        width: 100%;
        height: 100vh;
        background: url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
