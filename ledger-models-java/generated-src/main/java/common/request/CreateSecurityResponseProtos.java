...
public final class CreateSecurityResponseProtos {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ecurity_request.proto\"\270\001\n\033CreateSecurity" +
      "ResponseProto\022\024\n\014object_class\030\001 \001(\t\022\017\n\007v" +
      "ersion\030\002 \001(\t\022>\n\020security_request\030\024 \003(\0132$" +
      ".security.CreateSecurityRequestProto\0222\n\021" +
      "security_response\030\036 \003(\0132\027.security.Secur" +
      "ityProtoB0\n\016common.requestB\034CreateSecuri" +
      "tyResponseProtosP\001b\006proto3"
    };
    ...
    internal_static_security_CreateSecurityResponseProto_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_security_CreateSecurityResponseProto_descriptor,
        new java.lang.String[] { "ObjectClass", "Version", "SecurityRequest", "SecurityResponse", });
    common.models.security.SecurityProtos.getDescriptor();
    common.request.CreateSecurityRequestProtos.getDescriptor();
  }
