...
export interface ISecurityServer extends grpc.UntypedServiceImplementation {
    ...
    search: grpc.handleUnaryCall<fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto>;
...
export interface ISecurityClient {
    ...
    search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
    search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
    search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
...
export class SecurityClient extends grpc.Client implements ISecurityClient {
    ...
    public search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
    public search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
    public search(request: fintekkers_requests_security_query_security_request_pb.QuerySecurityRequestProto, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: fintekkers_requests_security_query_security_response_pb.QuerySecurityResponseProto) => void): grpc.ClientUnaryCall;
