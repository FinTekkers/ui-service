...
<div class="sign_up_fields">
    ...
    <label for="surname">
        ...
        <input
            class="rounded-md sign_up_surname"
            type="text"
            name="lastname"
            id="lastname"
            value={form?.lastname ?? ""}
    ...
    <label for="email">
        ...
        <input
            class="rounded-md sign_up_email"
            type="email"
            name="email"
            id="email"
            value={form?.email ?? ""}
    ...
    <label for="password">
        ...
        <input
            class="rounded-md sign_up_password"
        ...
        {#if isPasswordVisible}
            <span
                class="togglePasswordDisplayIcon_signUp"
                on:keydown={() => "x"}
                on:click={() =>
                    customBooleanStoreUpdater(booleanKeys.IS_PASSWORD_VISIBLE)}
            >
                <Icon
    ...
    <label for="confirmpassword">
        ...
        <input
            class="rounded-md sign_up_confirm_password"
            type={isPasswordVisible ? "text" : "password"}
    ...
    <label for="signupcode">
        <span class="label_span_text">sign-up code:</span>
        <input
            class="rounded-md sign_up_code"
            type="text"
            name="signupcode"
            id="signupcode"
            ...
            value=""
        />
        {#if displayError("signupcode")}
            <div class="error_message">
                <p class="form_error">Sign-up code is required</p>
            </div>
        {/if}
    </label>
    ...
    <label for="submit">
        <button
            type="submit"
            class="form_btn text-white font-bold py-2 px-4 rounded"
            >Sign Up →
        </button>
    </label>
