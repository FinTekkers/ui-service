...
class Position():
    ...
    def get_field(self, field_to_get:FieldProto):
        ...
        return ProtoSerializationUtil.deserialize(Position.unpack_field(field_to_get))

    def get_measure(self, measure_to_get:MeasureProto):
        # tmp_measure:FieldMapEntry
        # for tmp_measure in self.positionProto.measures:
        return ProtoSerializationUtil.deserialize(Position.unpack_measure(measure_to_get))
    ...
    @staticmethod
    def unpack_field(field_to_unpack):
